...
insert into Department(DepartId,DepartName,Description) values (N'P001',N'Phòng giám đốc',N'Phòng làm việc của giám đốc công ty');
insert into Department(DepartId,DepartName,Description) values (N'P002',N'Phòng nhân viên',N'Phòng làm việc của nhân viên');
insert into Department(DepartId,DepartName,Description) values (N'P003',N'Phòng nhân sự',N'Phòng làm việc của bộ nhân sự');
...
update Department Set Salary = Salary * 1,1;
